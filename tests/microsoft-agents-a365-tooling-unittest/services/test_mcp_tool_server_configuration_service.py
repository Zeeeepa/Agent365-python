...
"""
Unit tests for McpToolServerConfigurationService.
"""
...
class TestMcpToolServerConfigurationService:
    """Test class for McpToolServerConfigurationService."""

    def setup_method(self):
        """Set up test fixtures before each test method."""
        self.service = McpToolServerConfigurationService()
    ...
    def test_initialization_default_logger(self):
        ...
        assert service._logger.name == "McpToolServerConfigurationService"
    ...
    def test_initialization_custom_logger(self):
        ...
        # Act
        service = McpToolServerConfigurationService(custom_logger)
    ...
    def test_parse_manifest_file_valid_content(self):
        ...
        try:
            ...
            # Assert
            assert len(result) == 2
            assert all(isinstance(config, MCPServerConfig) for config in result)
